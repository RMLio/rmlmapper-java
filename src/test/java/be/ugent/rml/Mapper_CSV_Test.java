...
public class Mapper_CSV_Test extends TestCore {
    ...
    public void evaluate_1025_CSV() {
        doMapping("test-cases/RMLTC1025_CSV/mapping.ttl", "test-cases/RMLTC1025_CSV/output.nq");
    }
    ...
    @Test
    public void evaluate_1028_CSV() {
        doMapping("test-cases/RMLTC1028-CSV/mapping.ttl", "test-cases/RMLTC1028-CSV/output.nq");
    }
}
