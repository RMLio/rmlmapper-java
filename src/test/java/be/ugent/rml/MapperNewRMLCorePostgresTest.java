...
public class MapperNewRMLCorePostgresTest extends PostgresTestCore {

    @BeforeAll
    public static void beforeClass() {
        logger = LoggerFactory.getLogger(MapperNewRMLCorePostgresTest.class);
    }
    ...
    public static Stream<Arguments> data() {
        return Stream.of(
                ...
                Arguments.of("RMLTC0003a", true, BOTH),
    ...
    @ParameterizedTest(name = "{index}: NewRMLCore_Postgres_CSV_Test_{0}")
    @MethodSource("data")
    ...
    private void mappingTest(String testCaseName, boolean expectedException, StrictMode strictMode) {
        prepareDatabase(String.format("src/test/resources/new-test-cases/core/%s-PostgreSQL/resource.sql", testCaseName), USERNAME, PASSWORD);

        String mappingPath = "./new-test-cases/core/" + testCaseName + "-PostgreSQL/mapping.ttl";
        String outputPath = "new-test-cases/core/" + testCaseName + "-PostgreSQL/output.nq";
