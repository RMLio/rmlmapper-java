...
public class DirectHttpRequestTarget extends HttpRequestTarget {
    ...
    public DirectHttpRequestTarget(Map<String, String> httpRequestInfo, String serializationFormat, List<Quad> metadata) throws IOException {
    ...
    public void close() {
        ...
        try {
            ...
            helper.executeHttpRequest(httpRequestInfo);
        } catch (Exception e) {
