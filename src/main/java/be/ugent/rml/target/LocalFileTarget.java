...
public class LocalFileTarget implements Target {
     ...
     */
    public LocalFileTarget(String path, String basePath, String serializationFormat, Charset encoding, String compression) {
        this.path = path;
        ...
        if(this.compression != null) {
            switch (this.compression.toLowerCase()) {
                case COMPRESSION.ZIP:
                    this.outputStream = new ZipOutputStream(this.outputStream);
                    break;
